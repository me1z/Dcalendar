...
Этот документ содержит подробные инструкции по созданию и настройке Telegram Bot для работы с приложением DCalendar.
...
3. **Следуйте инструкциям**
   - Введите название бота (например, "DCalendar - Календарь для пар")
...
3. **Заполните информацию**
   - **Title**: DCalendar
   - **Short description**: Календарь для планирования событий в паре
